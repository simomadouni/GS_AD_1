                                        ...
                                        <form action="code2.php" method="POST">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="CourseName" value="<?php echo $course['CourseName']; ?>" class="form-control"></br>
                                                    <label for="">Description :</label>
                                                    <input type="text" name="Description" value="<?php echo $course['Description']; ?>" class="form-control">

                                                </div>
                                                <div class="col-md-6">
                                                    <label for="">Credit Hours :</label>
                                                    <input type="number" name="CreditHours" value="<?php echo $course['CreditHours']; ?>" class="form-control"></br>
                                                    <label for="">Department:</label>
                                                    <input type="text" name="Department" value="<?php echo $course['Department']; ?>" class="form-control">
                                                ...
                                                <div class="col-md-12 "></br>
                                                    <form action="code2.php" method="POST">
                                                        ...
                                                        <button type="submit" class="btn btn-primary align-items-center" name="update_course_button">Update</button>
                                                    </form>
                                                </div>
