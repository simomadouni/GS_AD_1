                                        ...
                                        <form action="code3.php" method="POST">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" name="AmountPaid" value="<?php echo $payment['AmountPaid']; ?>" class="form-control">

                                                    <label for="CarteBancaire">Carte Bancaire</label>
                                                    <input type="radio" name="PaymentMethod" value="Carte Bancaire" <?php echo ($payment['PaymentMethod'] == 'Carte Bancaire') ? 'checked' : ''; ?> id="CarteBancaire" required>

                                                    <label for="Cashe">Cashe</label>
                                                    <input type="radio" name="PaymentMethod" value="Cashe" <?php echo ($payment['PaymentMethod'] == 'Cashe') ? 'checked' : ''; ?> id="Cashe" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="">Payment Date :</label>
                                                    <input type="date" name="PaymentDate" value="<?php echo $payment['PaymentDate']; ?>" class="form-control">
                                                ...
                                                <div class="col-md-12 ">
                                                    <form action="code3.php" method="POST">
                                                        ...
                                                        <button type="submit" class="btn btn-primary align-items-center" name="update_payment_button">Update</button>
                                                    </form>
                                                </div>
