                                ...
                                <form action="code3.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="AmountPaid" placeholder="Entre Your Amount Paid" class="form-control"></br>
                                            <label for="">Payment Method :</label></br>
                                            <label for="CarteBancaire">Carte Bancaire</label>
                                            <input type="radio" name="PaymentMethod" id="CarteBancaire" value="CarteBancaire" required>
                                            <label for="Cashe">Cashe</label>
                                            <input type="radio" name="PaymentMethod" id="Cashe" value="Cashe" required>

                                        </div>
                                        <div class="col-md-6">
                                        <label for="">Student ID :</label>
                                            <select class="form-select" aria-label="Default select example" name="students_id" id="student_id">
                                                <option selected disabled>Student</option>
                                                <?php
                                                foreach ($studentIDs as $student) {
                                                    echo "<option value=\"{$student['id']}\">{$student['id']}</option>";
                                                }
                                                ?>
                                            </select><br>

                                            <label for="">Payment Date :</label>
                                            <input type="date" name="PaymentDate" placeholder="Entre Your Payment Date" class="form-control">

                                        </div>
                                        <div class="col-md-12 ">
                                            <button type="submit" class="btn btn-primary align-items-center" name="add_payment_button">Save</button>
