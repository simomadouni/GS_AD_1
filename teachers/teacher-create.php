				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							...
							<div class="order">
							<h4>ADD TEACHERS :</h4>
								<form action="../teachers/code4.php" method="POST">
									<div class="row">
										<div class="col-md-6">
										<label for="">First Name :</label>
											...
											<input type="text" name="Department" placeholder="Entre Your Department  " class="form-control">
										...
										<div class="col-md-6">
											...
											<input type="date" name="HireDate" placeholder="Entre Your Date" class="form-control" required>
											<label for=""> Specialization :</label>
											<input type="texte" name="Specialization" placeholder="Entre Your Specialization" class="form-control">
										</div>
										<div class="col-md-12 ">
											<button type="submit" class="btn btn-primary align-items-center" name="add_teacher_button">Save</button>
