	...
	<section id="content">
		...
		<nav>
			...
			if (isset($_POST['submit'])) {
				...
				$sql = "SELECT * FROM teachers WHERE firstName LIKE '%$search%'";
											...
											<tbody>
												...
												?>
														...
														<tr>
															...
															<td>
																<a href="teacher-edit.php?id=<?= $teacher['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
																<form action="code4.php" method="POST" class="d-inline">
																	<input type="hidden" name="id" value="<?= $teacher['id']; ?>">
																	<button type="submit" class="btn btn-danger btn-sm" name="delete_teacher_button">Delete</button>
																</form>
															</td>
