                    ...
                    <div class="col-md-12">
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                $enrollment = mysqli_fetch_array($query_run);
                        ?>
                                <div class="card">
                                        ...
                                        <form action="code1.php" method="POST">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" name="EnrollmentDate" value="<?php echo $enrollment['EnrollmentDate']; ?>" class="form-control">
                                                    ...
                                                    <div class="col-md-12 ">
                                                        <form action="code1.php" method="POST">
                                                            ...
                                                            <button type="submit" class="btn btn-primary align-items-center" name="update_enrollment_button">Update</button>
                                                        </form>
                                                    </div>
